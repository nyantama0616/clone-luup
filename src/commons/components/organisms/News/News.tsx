...
export function NewsItem({ imageInfo, date, title, className = "" }: NewsItemProps) {
    ...
    return (
        <li className={_className}>
            <a className="flex py-2 md:py-8 md:gap-4 items-center" href="#" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                <ImageZoomable imageInfo={imageInfo} isHovered={isHovered} className="w-[100px] h-[50px] md:w-[180px] md:h-[96px] flex-shrink-0" rounded={false} />
